...
def stats(update, context):
    ...
    stats = f'<b>𝗦𝗼𝗺𝗲𝗱𝗮𝘆 𝗺𝘆 𝗱𝗿𝗲𝗮𝗺 𝘄𝗶𝗹𝗹 𝗰𝗼𝗺𝗲? 𝗢𝗻𝗲 𝗱𝗮𝘆 𝘆𝗼𝘂 𝘄𝗶𝗹𝗹 𝘄𝗮𝗸𝗲 𝘂𝗽 𝗮𝗻𝗱 𝘆𝗼𝘂 𝘄𝗶𝗹𝗹 𝗱𝗶𝘀𝗰𝗼𝘃𝗲𝗿 𝗶𝘁 𝗻𝗲𝘃𝗲𝗿 𝗵𝗮𝗽𝗽𝗲𝗻𝗲𝗱. 𝗜𝘁𝘀 𝗶𝘀 𝗮𝗹𝗹 𝘁𝘂𝗿𝗻𝗲𝗱 𝗮𝗿𝗼𝘂𝗻𝗱 𝗼𝗻 𝘆𝗼𝘂. 𝗜𝘁 𝗻𝗲𝘃𝗲𝗿 𝘄𝗶𝗹𝗹. 𝗦𝘂𝗱𝗱𝗲𝗻𝗹𝘆 𝘆𝗼𝘂 𝗮𝗿𝗲 𝗼𝗹𝗱. 𝗗𝗶𝗱 𝗻𝗼𝘁 𝗵𝗮𝗽𝗽𝗲𝗻. 𝗔𝗻𝗱 𝗶𝘁 𝗻𝗲𝘃𝗲𝗿 𝘄𝗶𝗹𝗹 𝗯𝗲𝗰𝗮𝘂𝘀𝗲 𝘆𝗼𝘂 𝘄𝗲𝗿𝗲 𝗻𝗲𝘃𝗲𝗿 𝗴𝗼𝗻𝗻𝗮 𝗱𝗼 𝗶𝘁 𝗮𝗻𝘆𝘄𝗮𝘆. 𝘆𝗼𝘂 𝘄𝗶𝗹𝗹 𝗽𝘂𝘀𝗵 𝗶𝘁 𝗶𝗻𝘁𝗼 𝗺𝗲𝗺𝗼𝗿𝘆 𝘁𝗵𝗲𝗻 𝘇𝗼𝗻𝗲 𝗼𝘂𝘁 𝗶𝗻 𝘆𝗼𝘂𝗿 𝗕𝗮𝗿𝗰𝗮𝗹𝗼𝘂𝗻𝗴𝗲𝗿 𝗯𝗲𝗶𝗻𝗴 𝗵𝘆𝗽𝗻𝗼𝘁𝗶𝘇𝗲𝗱 𝗯𝘆 𝗱𝗮𝘆𝘁𝗶𝗺𝗲 𝗧𝗩 𝗳𝗼𝗿 𝘁𝗵𝗲 𝗿𝗲𝘀𝘁 𝗼𝗳 𝘆𝗼𝘂𝗿 𝗹𝗶𝗳𝗲.</b>\n' \
            f'<b>╭─────────「 VegaCloudBot4 」</b>\n' \
            f'<b>│</b>\n' \
